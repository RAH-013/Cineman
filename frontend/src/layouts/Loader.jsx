...
function Loader() {
    // Vector con la forma de la cinta
    ...
    return (
        <div className="w-full h-full flex flex-col items-center justify-center gap-6">
            ...
            {/* Estilos inyectados para el parpadeo de proyector retro */}
            <style>
                {`
            ...
            <div className="relative w-64 h-48 drop-shadow-[0_0_15px_rgba(168,85,247,0.2)]">
                <svg viewBox="0 0 250 200" className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
                    ...
                    {/* --- RAYO DE LUZ DEL LENTE --- */}
                    {/* Cono con la nueva clase animate-flicker */}
                    <polygon
                    ...
                    {/* Detalles frontales (visores/botones) */}
                    ...
                    {/* Cristal del lente también sincronizado con animate-flicker */}
